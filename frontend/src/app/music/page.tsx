                ...
                <div className="w-2/10">
                    <div className="flex flex-col items-center bg-neutral shadow-lg h-fit rounded">
                        ...
                        <div className="rounded flex space-x-2 items-center w-full justify-between px-4 py-2">
                            ...
                            <p className="font-bold text-xl flex items-center">{totalOwnedValue ? `£${totalOwnedValue.toLocaleString()}` : "N/A"}</p>
                        </div>
                        <div className="rounded flex space-x-2 items-center w-full justify-between px-4 py-2">
                            <h3 className="text-sm font-source font-light">Total Value</h3>
                            <p className="font-bold text-xl flex items-center">{totalValue ? `£${totalValue.toLocaleString()}` : "N/A"}</p>
                        </div>
                        <div className="rounded flex space-x-2 items-center w-full justify-between px-4 py-2">
                            <h3 className="text-sm font-source font-light">Average Price</h3>
                            <p className="font-bold text-xl flex items-center">{avgPrice ? `£${Number(avgPrice).toLocaleString()}` : ""}</p>
                        </div>
                        </div>
                    </div>
                </div>
