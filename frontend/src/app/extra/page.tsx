...
export default function ExtraPage() {
  ...
  const groupByTheme = filteredExtra.reduce<Record<string, Extra[]>>(
    (acc, item) => {
  ...
  return (
    <div className="p-4 sm:p-6 flex flex-col w-full min-h-screen">
      <div className="flex justify-center sm:justify-start items-center mb-4 sm:mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold">Extra Collections</h1>
      </div>
