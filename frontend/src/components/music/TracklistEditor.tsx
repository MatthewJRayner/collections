    ...
    return (
        <div className="p-3 rounded bg-neutral shadow w-full">
            ...
            >
                ...
                <span className={`transition duration-400 ${tracksView ? "text-primary" : ""}`}>▼</span>
            </button>
            {tracksView && (
                <>
                    {tracklist.map((track: Track, index: number) => (
                        <div key={index} className="mb-3 bg-background shadow p-2 rounded">
                            ...
                            <button
                                ...
                                className="bg-danger text-white text-sm px-2 py-1 rounded cursor-pointer hover:bg-red-500 transition"
                            >
                                Remove
                            </button>
                        </div>
